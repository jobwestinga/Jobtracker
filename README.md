...
- **Offline & Fully Local:** Your data never leaves your computer. Backed by a local SQLite engine, all your tracking history is private and portable. Every clean quit also writes a rotating JSON auto-backup (newest 10 kept) next to your database.
