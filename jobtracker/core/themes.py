...
FX_STYLES: Dict[str, Dict[str, str]] = {
    ...
    "Glassmorphism": {
        ...
        "CARD_BG":           "{BG_SECONDARY_A120}",
        "CARD_HOVER_BG":     "{BG_TERTIARY_A140}",
        "CARD_HOVER_BORDER": "1.4px solid {TEXT_PRIMARY_A170}",
        "TIMER_BG":          "{BG_SECONDARY_A115}",
    ...
    "Neon": {
        "CARD_BORDER_STYLE": "1.5px solid {ACCENT_A155}",
        "CARD_BG":           "{BG_PRIMARY_A150}",
        "CARD_HOVER_BG":     "{BG_SECONDARY_A170}",
        "CARD_HOVER_BORDER": "2px solid {ACCENT}",
        "TIMER_BG":          "{BG_PRIMARY_A140}",
        "TIMER_BORDER":      "2px solid {ACCENT}",
        "IDLE_BORDER":       "2px dashed {ACCENT_A120}",
        "RADIUS":            "12px",
        "SUBJECT_RADIUS":    "12px",
        "TASK_RADIUS":       "10px",
    },
